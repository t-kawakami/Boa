...
def detect_face():
    ...
    facerect = cascade.detectMultiScale(img_gray, scaleFactor=1.1, minNeighbors=1, minSize=(50, 50))
...
img_dir = "./data/image/sample/"
#img_dir = "./data/movie/train/train/NG/"
dedicated_dir = "./data/image/dedicated/"

cascade_files = [cascade_children for cascade_children in os.listdir(cascade_dir) if re.compile("cascade.*.xml").match(cascade_children)]
